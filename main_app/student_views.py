...
def student_home(request):
    ...
    if not student.course:
        from django.contrib import messages
        messages.error(request, "Your course is not assigned. Please contact admin.")
        context = {'page_title': 'Student Homepage', 'total_attendance': 0, 'percent_present': 0, 
                   'percent_absent': 0, 'total_subject': 0, 'subjects': []}
